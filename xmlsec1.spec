...
Version  : 1.3.5
Release  : 44
URL      : https://github.com/lsh123/xmlsec/archive/xmlsec_1_3_5/xmlsec-1.3.5.tar.gz
Source0  : https://github.com/lsh123/xmlsec/archive/xmlsec_1_3_5/xmlsec-1.3.5.tar.gz
...
%prep
%setup -q -n xmlsec-xmlsec_1_3_5
cd %{_builddir}/xmlsec-xmlsec_1_3_5
%patch -P 1 -p1
pushd ..
cp -a xmlsec-xmlsec_1_3_5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721423780
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxmlsec1-gcrypt.so.1.3.5
/V3/usr/lib64/libxmlsec1-gnutls.so.1.3.5
/V3/usr/lib64/libxmlsec1-nss.so.1.3.5
/V3/usr/lib64/libxmlsec1-openssl.so.1.3.5
/V3/usr/lib64/libxmlsec1.so.1.3.5
/usr/lib64/libxmlsec1-gcrypt.so.1
/usr/lib64/libxmlsec1-gcrypt.so.1.3.5
/usr/lib64/libxmlsec1-gnutls.so.1
/usr/lib64/libxmlsec1-gnutls.so.1.3.5
/usr/lib64/libxmlsec1-nss.so.1
/usr/lib64/libxmlsec1-nss.so.1.3.5
/usr/lib64/libxmlsec1-openssl.so.1
/usr/lib64/libxmlsec1-openssl.so.1.3.5
/usr/lib64/libxmlsec1.so.1
/usr/lib64/libxmlsec1.so.1.3.5
