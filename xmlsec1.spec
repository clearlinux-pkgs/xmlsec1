...
Version  : 1.3.2
Release  : 39
URL      : https://github.com/lsh123/xmlsec/archive/xmlsec_1_3_2/xmlsec-1.3.2.tar.gz
Source0  : https://github.com/lsh123/xmlsec/archive/xmlsec_1_3_2/xmlsec-1.3.2.tar.gz
...
%prep
%setup -q -n xmlsec-xmlsec_1_3_2
cd %{_builddir}/xmlsec-xmlsec_1_3_2
%patch -P 1 -p1
pushd ..
cp -a xmlsec-xmlsec_1_3_2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698876032
...
cp %{_builddir}/xmlsec-xmlsec_1_3_2/Copyright %{buildroot}/usr/share/package-licenses/xmlsec1/f75f047fc74ec748a8b328071a567b28ee1113e3 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxmlsec1-gcrypt.so.1.3.2
/V3/usr/lib64/libxmlsec1-gnutls.so.1.3.2
/V3/usr/lib64/libxmlsec1-nss.so.1.3.2
/V3/usr/lib64/libxmlsec1-openssl.so.1.3.2
/V3/usr/lib64/libxmlsec1.so.1.3.2
/usr/lib64/libxmlsec1-gcrypt.so.1
/usr/lib64/libxmlsec1-gcrypt.so.1.3.2
/usr/lib64/libxmlsec1-gnutls.so.1
/usr/lib64/libxmlsec1-gnutls.so.1.3.2
/usr/lib64/libxmlsec1-nss.so.1
/usr/lib64/libxmlsec1-nss.so.1.3.2
/usr/lib64/libxmlsec1-openssl.so.1
/usr/lib64/libxmlsec1-openssl.so.1.3.2
/usr/lib64/libxmlsec1.so.1
/usr/lib64/libxmlsec1.so.1.3.2
