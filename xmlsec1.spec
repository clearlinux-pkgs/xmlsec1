...
Source0  : https://github.com/lsh123/xmlsec/archive/xmlsec-1_2_27.tar.gz
...
%prep
%setup -q -n xmlsec-xmlsec-1_2_27
...
export LANG=C
export SOURCE_DATE_EPOCH=1546995860
...
/usr/lib64/libxmlsec1-nss.so.1.2.27
/usr/lib64/libxmlsec1-openssl.so.1
/usr/lib64/libxmlsec1-openssl.so.1.2.27
/usr/lib64/libxmlsec1.so.1
/usr/lib64/libxmlsec1.so.1.2.27
