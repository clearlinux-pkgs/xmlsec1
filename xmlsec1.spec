...
Version  : 1.2.29
Release  : 26
URL      : https://github.com/lsh123/xmlsec/archive/xmlsec-1_2_29/xmlsec-1.2.29.tar.gz
Source0  : https://github.com/lsh123/xmlsec/archive/xmlsec-1_2_29/xmlsec-1.2.29.tar.gz
...
%prep
%setup -q -n xmlsec-xmlsec-1_2_29
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571499511
...
cp %{_builddir}/xmlsec-xmlsec-1_2_29/Copyright %{buildroot}/usr/share/package-licenses/xmlsec1/f75f047fc74ec748a8b328071a567b28ee1113e3
%make_install
...
/usr/lib64/libxmlsec1-gcrypt.so.1.2.29
/usr/lib64/libxmlsec1-gnutls.so.1
/usr/lib64/libxmlsec1-gnutls.so.1.2.29
/usr/lib64/libxmlsec1-nss.so.1
/usr/lib64/libxmlsec1-nss.so.1.2.29
/usr/lib64/libxmlsec1-openssl.so.1
/usr/lib64/libxmlsec1-openssl.so.1.2.29
