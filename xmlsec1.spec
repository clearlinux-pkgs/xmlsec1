...
%prep
%setup -q -n xmlsec-xmlsec_1_3_1
cd %{_builddir}/xmlsec-xmlsec_1_3_1
%patch -P 1 -p1
pushd ..
cp -a xmlsec-xmlsec_1_3_1 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxmlsec1-gcrypt.so.1.3.1
/V3/usr/lib64/libxmlsec1-gnutls.so.1.3.1
/V3/usr/lib64/libxmlsec1-nss.so.1.3.1
/V3/usr/lib64/libxmlsec1-openssl.so.1.3.1
/V3/usr/lib64/libxmlsec1.so.1.3.1
/usr/lib64/libxmlsec1-gcrypt.so.1
/usr/lib64/libxmlsec1-gcrypt.so.1.3.1
/usr/lib64/libxmlsec1-gnutls.so.1
/usr/lib64/libxmlsec1-gnutls.so.1.3.1
/usr/lib64/libxmlsec1-nss.so.1
/usr/lib64/libxmlsec1-nss.so.1.3.1
/usr/lib64/libxmlsec1-openssl.so.1
/usr/lib64/libxmlsec1-openssl.so.1.3.1
/usr/lib64/libxmlsec1.so.1
/usr/lib64/libxmlsec1.so.1.3.1
